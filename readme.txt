...
WPA SEO Auto Linker assists in creating cornerstone SEO content. This is not a replacement for tools like Yoast SEO but an extra tool.
...
= Is this plugin compatible with Gutenburg? =

We are curretly working on supporting Gutenburg. Please mind that Gutenburg is work in progress and there's still lots of changes being made to the editor. Gutenburg isn't stable yet, but our plan is to have solid Gutenburg support once Gutenburg is stable.
